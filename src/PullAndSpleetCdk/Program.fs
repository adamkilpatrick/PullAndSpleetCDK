...
let main _ =
    ...
    let deployStage = new DeployStage(app, "DeployStage", new PullAndSpleetCdkStackProps(pipelineStack.ecrRepoArn.ImportValue, pipelineStack.ecrRepoName.ImportValue, pipelineStack.imageTagParameterArn.ImportValue))
